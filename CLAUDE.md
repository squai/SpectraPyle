...
- **CLADE DO NOT COMMIT** Salvatore will handles entirely the github repository (including commits), after manually testing the outcomes. Please, remind Salvatore to run manual tests\
