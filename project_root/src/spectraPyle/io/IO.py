...
def save_to_file(config, data_dict):
    ...
    cols = fits.ColDefs([
        ...
        fits.Column(name='specMode', format='D', array=data_dict['stackSPmode']),
        fits.Column(name='specModeDispersion', format='D', array=data_dict['stackDISPmode']),
        fits.Column(name='specModeError', format='D', array=data_dict['stackERmode']),
        fits.Column(name='specStrictGeometricMean', format='D', array=data_dict['stackSPgeomMeanStrict']),
        fits.Column(name='specStrictGeometricMeanDispersion', format='D', array=data_dict['stackDISPgeomMeanStrict']),
        fits.Column(name='specStrictGeometricMeanError', format='D', array=data_dict['stackERgeomMeanStrict']),
